<template>
  <div class="echarts">
    <div class="fanHui" @click="fanHui">返回到主地图</div>
...
import resize from "../../../../static/mixins/resize";
export default {
  name: "allMap",
  mixins: [resize],
  data() {
    return {
      ...
      timeTitle: ["2017", "2018", "2019", "2020", "2021"],
    };
  },
  mounted() {
            ...
            feature: {
              ...
              dataView: {
                optionToContent: function (opt) {
                  ...
                  let tdBodys = ""; //数据
                  let table = `<table border="1" style="margin-left:10px;border-collapse:collapse;font-size:14px;text-align:left;"><tbody><tr>${tdHeads} </tr>`;
      ...
      this.timeTitle.forEach((item) => {
        ...
        option.options.push({
          title: [
            ...
            {
              text: "已就业人数总额：" + sum[item].toFixed(2) + "万",
              left: "center",
              top: "6.5%",
              textStyle: {
                color: "#FFAC50",
