...
export default {
  ...
  watch:{
    isDeldec:'deletetCommunityMsg'
  },
  methods: {
     deletetCommunityMsg(cur,old){
      this.getListData()
      let params = {
        id:this.id
      }
    ...
    sendMsg() {
      ...
      this.$emit("message", {id:this.id,title:this.title,index:this.index,ishowmessage:this.ishowmessage,name:'社区活动消息通知'});
    },
  },
};
</script>
