...
router.post('/initFace',user.initFace)
router.post('/checkFace',user.checkFace)
// 天气查询
router.post('/weather',user.weather)

//用接口地址，返回用户信息  npm install express-passport 验证中间件
router.post('/current',passport.authenticate("jwt",{session:false}),user.current)
